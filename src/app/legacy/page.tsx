...
import { TreeLayout, TreeQuizData } from '../api/__legacy/components/quizList';
...
} from '../api/__legacy/components/codeFeedbackModule';
import { answerCheckPrompt } from '../api/__legacy/components/answerCheckModule';
                                        ...
                                        <Button
                                            onClick={() => {
                                                ...
                                                if (isCodeEmptyOrNonExecutable(studentCode) === true) {
                                                    ...
                                                    axios.post('/api/oldAnswerCheckAPI', {
                                                        headers: {
